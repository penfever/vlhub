...
save_csv = "/scratch/bf996/vlhub/logs/dcc-easyrobust-results.csv"

increment = 0

while os.path.exists(save_csv):
    increment += 1
    save_csv = "/scratch/bf996/vlhub/logs/dcc-easyrobust-results-{}.csv".format(increment)

script_path = 'python src/training/main.py --batch-size=128 --workers=8 --easyrobust_eval --stylized_imagenet /imagenet-style --imagenet_c /imagenet-c --objectnet "/objectnet-1.0/images" --report-to wandb --model=RN50 --resume={} --zeroshot-frequency=1 --save-results-to-csv={};'
